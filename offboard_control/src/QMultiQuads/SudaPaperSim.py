...
if __name__ == "__main__":
    ...
    with open('/home/jaq394l/catkin_ws/src/PX4_ROS_packages/offboard_control/src/QMultiQuads/statehistory_target.txt','rb') as csvfile:
        totalstate1 = csv.reader(csvfile, delimiter=',', quotechar='|')
        for row in totalstate1:
             traj1.append(map(int,row))

    with open('/home/jaq394l/catkin_ws/src/PX4_ROS_packages/offboard_control/src/QMultiQuads/statehistory1.txt','rb') as csvfile:
        totalstate2 = csv.reader(csvfile, delimiter=',', quotechar='|')
        for row in totalstate2:
             traj2.append(map(int,row))

    with open('/home/jaq394l/catkin_ws/src/PX4_ROS_packages/offboard_control/src/QMultiQuads/statehistory2.txt','rb') as csvfile:
        totalstate3 = csv.reader(csvfile, delimiter=',', quotechar='|')
        for row in totalstate3:
             traj3.append(map(int,row))

    with open('/home/jaq394l/catkin_ws/src/PX4_ROS_packages/offboard_control/src/QMultiQuads/statehistory3.txt','rb') as csvfile:
    ...
    initial_pos_1 = Point(0,0,2)
    initial_pos_2 = Point(0,0,2)
    initial_pos_3 = Point(0,0,2)
    initial_pos_4 = Point(0,0,2)
