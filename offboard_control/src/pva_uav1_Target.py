...
if __name__ == "__main__":
    ...
    # Initialize node.
    rospy.init_node('Quad1_offboard_pvacontrol')
    ...
    rospy.Subscriber("/uav1/mavros/local_position/odom",Odometry , curr_pos_callback)
    ...
    for s in traj:
    # for s in traj[:10]: # Chnage the size of the trajectory to test.
