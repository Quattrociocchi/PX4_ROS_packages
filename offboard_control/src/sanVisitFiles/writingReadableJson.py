...
if __name__ == "__main__":
    ...
    directory = '/home/jaq394l/catkin_ws/PX4_ROS_packages/offboard_control/src/sanVisitFiles/' # <------ Set this to the directory where the json file lives. NOTE the trailing / 
    # jsonInputFile = directory + 'Example2_Gazebo.json' # <------ This is the name of your json file. NOTE there is no / in front of the name
    jsonInputFile = 'Example3_Gazebo.json'
    ...
    readableOutputFile = 'readable_Example3_Gazebo.json'
